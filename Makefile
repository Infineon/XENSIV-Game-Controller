...
# added to the build
#
COMPONENTS=FREERTOS WICED_BLE EMWIN_NOSTS
...
INCLUDES=./configs ../mtb_shared/wiced_btsdk/dev-kit/libraries/btsdk-hid/release-v4.4.2/COMPONENT_hidh_lib /mtb_shared/wiced_btsdk/dev-kit/baselib/20835B1/release-v4.4.2/COMPONENT_20835B1/include/stack

# Add additional defines to the build process (without a leading -D).
DEFINES=CY_RETARGET_IO_CONVERT_LF_TO_CRLF CY_RTOS_AWARE EMWIN_ENABLED
